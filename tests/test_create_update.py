...
from src.data_set.user_test_data import upd_user
from src.schemas.schema import CreateUser, UpdateUser
...
async def test_update_users_with_patch(async_client):
    r = await async_client.patch(f'{BASE_URL}/{randint(1, 12)}', data=upd_user)
